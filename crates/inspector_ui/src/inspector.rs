            ...
            h_flex()
                ...
                .child(
                    IconButton::new("pick-mode", IconName::MagnifyingGlass)
                        .tooltip(Tooltip::text(locale::t_static("Start inspector pick mode")))
                ...
                .child(
                    h_flex()
                        .justify_end()
                        .child(Label::new(locale::t_static("GPUI Inspector"))),
                ),
        )
        .child(
            v_flex()
...
fn render_inspector_id(inspector_id: &InspectorElementId, cx: &App) -> Div {
    ...
    v_flex()
        .child(
            h_flex()
                .justify_between()
                .child(Label::new(locale::t_static("Element ID")).size(LabelSize::Large))
                .child(
                    div()
                        .id("instance-id")
                        .text_ui(cx)
