...
impl ZedAiOnboarding {
    ...
    fn render_sign_in_disclaimer(&self, _cx: &mut App) -> AnyElement {
        ...
        v_flex()
            ...
            .relative()
            .gap_1()
            .child(Headline::new(locale::t_static("Welcome to Zed AI")))
            .child(
                Label::new(locale::t_static(
                    "Sign in to try GPT Luna. Your 14 days begin when you start the trial.",
                ))
                .color(Color::Muted)
                .mb_2(),
            )
            ...
            .child(
                Button::new("sign_in", locale::t_static("Sign In to Try GPT Luna"))
                    .disabled(signing_in)
                    .full_width()
            ...
            v_flex()
                ...
                .child(
                    v_flex()
                        ...
                        .child(
                            Button::new("pro", locale::t_static("Get Started"))
                                .full_width()
                                .style(ButtonStyle::Tinted(ui::TintColor::Accent))
                    ...
                    v_flex()
                        ...
                        .child(
                            h_flex()
                                .gap_2()
                                .child(
                                    Label::new(locale::t_static("Free"))
                                        .size(LabelSize::Small)
                                        .color(Color::Muted)
                                        .buffer_font(cx),
                                )
                                .child(
                                    Label::new(locale::t_static("(Current Plan)"))
                                        .size(LabelSize::Small)
                                        .color(Color::Custom(
                    ...
                    v_flex()
                        ...
                        .child(
                            h_flex()
                                .gap_2()
                                .child(
                                    Label::new(locale::t_static("Pro Trial"))
                                        .size(LabelSize::Small)
                                        .color(Color::Accent)
                                        .buffer_font(cx),
                                )
                        ...
                        .child(
                            Button::new("pro", locale::t_static("Start Free Trial"))
                                .full_width()
                                .style(ButtonStyle::Tinted(ui::TintColor::Accent))
                                .on_click(move |_, _window, cx| {
                                    telemetry::event!(
    ...
    fn render_trial_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new(locale::t_static(
                "Welcome to the Zed Pro Trial",
            )))
            .child(
                Label::new(locale::t_static(
                    "Included for 14 days from when your trial started:",
                ))
                .color(Color::Muted)
                .mb_2(),
            )
    ...
    fn render_pro_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new(locale::t_static("Welcome to Zed Pro")))
            .child(
                Label::new(locale::t_static("Here's what you get:"))
                    .color(Color::Muted)
                    .mb_2(),
            )
            .child(PlanDefinitions.pro_plan())
    ...
    fn render_business_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new(locale::t_static("Welcome to Zed Business")))
            .child(
                Label::new(locale::t_static("Here's what you get:"))
                    .color(Color::Muted)
                    .mb_2(),
    ...
    fn render_vip_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new(locale::t_static("Welcome to Zed VIP")))
            .child(
                Label::new(locale::t_static("Here's what you get:"))
                    .color(Color::Muted)
                    .mb_2(),
    ...
    fn render_student_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new(locale::t_static("Welcome to Zed Student")))
            .child(
                Label::new(locale::t_static("Here's what you get:"))
                    .color(Color::Muted)
                    .mb_2(),
