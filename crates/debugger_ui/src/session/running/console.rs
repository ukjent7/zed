...
impl Console {
    pub fn new(
        ...
        let query_bar = cx.new(|cx| {
            ...
            editor.set_placeholder_text(locale::t_static("Evaluate an expression"), window, cx);
            editor.set_use_autoclose(false);
            editor.set_show_gutter(false, cx);
            editor.set_show_wrap_guides(false, cx);
            editor.set_show_indent_guides(false, cx);
                    ...
                    this.menu(move |window, cx| {
                        Some(ContextMenu::build(window, cx, |context_menu, _, _| {
                            context_menu
                                ...
                                .action(
                                    locale::t_static("Watch Expression"),
                ...
                this.child(Divider::horizontal()).child(
                    h_flex()
                        ...
                        .child(SplitButton::new(
                            ...
                            .child(Label::new(locale::t_static("Evaluate")))
                            .tooltip({
                                let query_focus_handle = query_focus_handle.clone();

                                move |_window, cx| {
                                    Tooltip::for_action_in(
                                        locale::t_static("Evaluate"),
                                        &Confirm,
                                        &query_focus_handle,
                                        cx,
                                    )
